...
from .pipeline_metadata import ensure_pipeline_supported, pipeline_cli_value
...
class TRELLIS_OT_AddMultiImage(Operator):
    ...
    def execute(self, context):
        ...
        if not ensure_pipeline_supported(pipeline_choice, self, mode='MULTI_IMAGE'):
            return {'CANCELLED'}
...
class TRELLIS_OT_GenerateFromMultiImage(Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            if 'mesh' in outputs:
                from .mesh_utils import export_glb, import_glb, center_object, scale_object_to_size, convert_tris_to_quads
